...
- `AfsmGraphReducer<S, E, C, F>` graphable reducer boundary with an initial state.
...
- `afsm-viewmodel` with `ViewModel.afsmHost(...)`, including a graphable machine overload.
