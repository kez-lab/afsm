...
public fun interface AfsmCommandHandler<C : Any, E : Any> {
     ...
     *
     * Command results should be converted back into events through [send]. The
     * runtime queues sent events instead of re-entering the state machine
     * recursively. The same handler executes phase-owned invocations; those
     * implementations must cooperate with coroutine cancellation.
     */
