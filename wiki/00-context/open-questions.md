...
- A minimal executable DSL and interpreter spike compiles and passes ProductEditor-like `afsm-core` tests; graph metadata/export and ProductEditor migration remain unresolved.
