...
- Maven local publishing now works for `afsm-core`, `afsm-runtime`, `afsm-viewmodel`, `afsm-compose`, and `afsm-graph-ksp` using `io.github.afsm:*:0.1.0-SNAPSHOT` pre-release coordinates.
