...
- [[03-engineering/afsm-v3-topology-first-api|Afsm v3 Typed Handler API]] - Canonical v3 direction: plain Kotlin `when`, concrete State/Event handlers, and graph extraction from `transitionTo`.
