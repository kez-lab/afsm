...
- [[03-engineering/afsm-v3-topology-first-api|Afsm v3 Topology-First API]] - ProductEditor-based comparison of v2 reducers and a graph-friendly typed-handler `when` convention.
