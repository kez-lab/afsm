// Bundled bilingual documentation for Afsm
window.afsmGuideData = {
  "getting-started": {
    "category": {
      "en": "Getting Started",
      "ko": "시작하기"
    ...
    "lead": {
      "en": "Build the smallest useful Android Afsm feature step-by-step.",
      "ko": "Afsm을 사용하여 가장 작고 실용적인 Android 화면 기능을 단계별로 구현합니다."
    },
    "prev": null,
    "next": "modeling-rules",
  ...
  "modeling-rules": {
    ...
    "lead": {
      "en": "Choose Phase, Data, Event, and Command boundaries without forcing FSM ceremony.",
      "ko": "불필요한 FSM 의식 없이 Phase, Data, Event, Command 경계를 올바르게 모델링합니다."
    },
    "prev": "getting-started",
    "next": "testing-guide",
    "github": "modeling-rules.md",
  ...
  "testing-guide": {
    ...
    "lead": {
      "en": "Test pure transitions, ViewModel wiring, runtime ordering, and graph contracts.",
      "ko": "순수 전이, ViewModel wiring, runtime 순서, graph contract를 테스트합니다."
    },
    "prev": "modeling-rules",
    "next": "graph-generation",
  ...
  "graph-generation": {
    ...
    "lead": {
      "en": "Generate Mermaid topology from the same executable machine definition.",
      "ko": "같은 실행 가능한 machine 정의에서 Mermaid topology를 자동 생성하고 검증합니다."
    },
    "prev": "testing-guide",
    "next": "restoration-command-ui-policy",
    "github": "graph-generation.md",
  ...
  "afsm-public-api": {
    ...
    "lead": {
      "en": "Complete reference for core types, DSL operations, runtime host, and diagnostics.",
      "ko": "핵심 타입, DSL 연산자, 런타임 호스트, 실패 정책 및 진단 API 전체 레퍼런스."
    },
    "prev": "sample-shop-afsm-guide",
    "next": "release-readiness",
    "github": "afsm-public-api.md",
  ...
  "auth-walkthrough": {
    ...
    "lead": {
      "en": "Conditional submit, async credentials validation, and durable authenticated state.",
      "ko": "조건부 폼 제출, 비동기 인증 처리 및 지속되는 인증 상태 관리."
    },
    "prev": "release-readiness",
    "next": "checkout-walkthrough",
    "github": "auth-walkthrough.md",
  ...
  "checkout-walkthrough": {
    ...
    "title": {
      "en": "Checkout Walkthrough",
      "ko": "Checkout 결제 화면 가이드"
    },
    "lead": {
      "en": "Dynamic initial state, payment retries, stale-result safety, and restoration policy.",
      "ko": "동적 초기 상태 주입, 결제 재시도, stale 결과 방어 및 복원 정책."
    },
    "prev": "auth-walkthrough",
    "next": "product-editor-walkthrough",
    "github": "checkout-walkthrough.md",
  ...
  "product-editor-walkthrough": {
    ...
    "title": {
      "en": "Product Editor Walkthrough",
      "ko": "Product Editor 화면 가이드"
    },
    "lead": {
      "en": "Nested editing, review workflow, and phase-owned cooperative upload cancellation.",
      "ko": "중첩 draft 편집, 심사 워크플로우 및 Phase 소유의 협력적 업로드 취소."
    },
    "prev": "checkout-walkthrough",
    "next": "examples",
    "github": "product-editor-walkthrough.md",
  ...
  "examples": {
    ...
    "lead": {
      "en": "Choosing an example and reading order for complex Android flows.",
      "ko": "안드로이드 화면 복잡도에 따른 예제 선택 가이드 및 추천 열람 순서."
    },
    "prev": "product-editor-walkthrough",
    "next": null,
    "github": "examples.md",
